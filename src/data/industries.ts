      ...
      cards: [
        {
          ...
          description:
            "Engineered for high-pressure, high-temperature applications where even the smallest deviation can have significant consequences.",
        },
        {
          title: "Fail-Safe by Design",
          description:
            "With advanced EHF actuator systems and intelligent control mechanisms, safety isn't an add-on. It's embedded into every operation.",
        },
        {
          title: "System-Level Responsiveness",
          description:
            "Our solutions sense, adjust, and respond dynamically to changing process conditions.",
        },
        {
          title: "Relentless Customization",
          description:
            "No two flow environments are identical. Rotex solutions are tailored to your exact process, ensuring optimal performance in real-world conditions.",
        },
        {
          title: "High-Cycle Reliability",
          description:
            "Built to withstand continuous operations with minimal wear, reducing downtime and extending system life.",
        },
        {
          title: "Global Standards Compliance",
          description:
            "Every component meets API, ATEX, IECEx, and SIL safety standards, ensuring seamless deployment across global oil and gas operations.",
        },
        {
          title: "Single-Supplier Integration",
          description:
            "From solenoid valves to full EHF actuator packages, Rotex simplifies your supply chain with fully integrated, pre-engineered solutions.",
        },
        {
          title: "Field-Proven Heritage",
          description:
            "Decades of deployment across Indian and international refineries, pipelines, and offshore platforms validate our engineering approach in the most demanding environments.",
        },
      ],
    },
    subIndustries: [
      {
        ...
        name: "Upstream",
        description:
          "Upstream oil & gas operations take place in some of the harshest and most safety-critical environments, from onshore wellheads and gathering systems to offshore platforms and remote production facilities. Reliable process automation is essential to keep production running and operators safe.",
        challengesTitle: "Process Challenges in Upstream Operation",
        solutionsTitle: "Rotex Solutions for Upstream Applications",
        solutionsIntro:
          "Rotex offers reliable process automation engineered for the harshest and most safety-critical operating environments, delivering:",
        challenges: [
      ...
      },
      {
        ...
        name: "Midstream",
        description:
          "Midstream operations handle transportation, storage, and processing of oil, gas, and NGLs across thousands of kilometres of pipelines and compressor stations. Precision control and zero-leak integrity are non-negotiable throughout the network.",
        challengesTitle: "Process Challenges in Midstream Operation",
        solutionsTitle: "Rotex Solutions for Midstream Applications",
        solutionsIntro:
          "Rotex delivers proven flow control solutions for the demanding midstream environment:",
        challenges: [
      ...
      },
      {
        ...
        name: "Downstream",
        description:
          "Downstream facilities — refineries, petrochemical plants, and distribution terminals — operate under strict process requirements. Continuous operation, precise control, and safety are critical to meeting output targets and regulatory standards.",
        challengesTitle: "Process Challenges in Downstream Operation",
        solutionsTitle: "Rotex Solutions for Downstream Applications",
        solutionsIntro:
          "Rotex provides precision-engineered flow control solutions purpose-built for downstream environments:",
        challenges: [
